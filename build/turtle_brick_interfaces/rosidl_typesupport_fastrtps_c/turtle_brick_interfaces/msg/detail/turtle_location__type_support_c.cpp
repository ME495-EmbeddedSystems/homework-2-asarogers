...
#include "turtle_brick_interfaces/msg/detail/turtle_location__rosidl_typesupport_fastrtps_c.h"
...
using _TurtleLocation__ros_msg_type = turtle_brick_interfaces__msg__TurtleLocation;
...
{
  const _TurtleLocation__ros_msg_type * ros_message = static_cast<const _TurtleLocation__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_brick_interfaces__msg__TurtleLocation;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const turtle_brick_interfaces__msg__TurtleLocation * ros_message = static_cast<const turtle_brick_interfaces__msg__TurtleLocation *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_turtle_brick_interfaces__msg__TurtleLocation(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  turtle_brick_interfaces__msg__TurtleLocation * ros_message = static_cast<turtle_brick_interfaces__msg__TurtleLocation *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_turtle_brick_interfaces__msg__TurtleLocation(cdr, ros_message);
}

static uint32_t _TurtleLocation__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_brick_interfaces__msg__TurtleLocation(
...
static size_t _TurtleLocation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_brick_interfaces__msg__TurtleLocation(
...
static message_type_support_callbacks_t __callbacks_TurtleLocation = {
...
static rosidl_message_type_support_t _TurtleLocation__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TurtleLocation,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_brick_interfaces, msg, TurtleLocation)() {
  return &_TurtleLocation__type_support;
}
